...
void krn_autorun(void){
	...
	Process * prc = prc_create("app_test", 1024*10, 1024*20, (uint32_t*)app_test, USERMODE_USER);
	//Process * prc = prc_create("app_shell", 1024*10, 1024*20, (uint32_t*)app_shell, USERMODE_USER);
